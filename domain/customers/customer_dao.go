...
const (
	queryInsertCustomer = `INSERT INTO customers(customer_id, customer_user_name, password, first_name, last_name, customer_email, phone_number, customer_created_at, is_customer) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9);`

	queryFindByEmail = `SELECT customer_id, customer_user_name, password, first_name, last_name, customer_email, phone_number, customer_created_at FROM customers WHERE customer_email=$1;`
...
func (db CustomerRepositoryDb) CustomerRegistration(u Customer) (*Customer, *utilerrors.RestErr) {
	...
	u.UserValidation()
	stmt.Exec(u.CustomerID, u.CustomerUserName, u.Password, u.FirstName, u.LastName, u.Email, u.PhoneNumber, u.CustomerCreatedt, u.IsCustomer)
...
func (db CustomerRepositoryDb) CustomerLogin(u Customer) (*Customer, utilerrors.RestErr) {
	...
	if err := security.ComparePassword(u.Password, authPass); err != nil {
